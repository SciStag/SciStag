...
ESSENTIAL_DATA_URL = \
    "https://github.com/SciStag/SciStagEssentialData/releases/download/v0.0.2/scistag_essentials_0_0_2.zip"
...
ESSENTIAL_DATA_ARCHIVE_NAME = os.path.normpath(os.path.dirname(__file__) +
