...
def test_font_bounding():
    ...
    vl.test.assert_image("canvas_text", canvas,
                         hash_val='6d4de9e99418eae8d0e7bbcf18ac1258')
    canvas.clear()
    canvas.text(pos=text_off, text=multiline_text, color=Colors.RED, font=font,
                h_align=HTextAlignment.CENTER,
                anchor=Anchor2D.TOP,
    ...
    vl.test.assert_image("canvas_text", canvas,
                         hash_val='3bbcf9cc24c21e3cb2bb6131f6660e3b')
    canvas.clear()
    canvas.text(pos=text_off, text=multiline_text, color=Colors.RED, font=font,
                h_align=HTextAlignment.CENTER,
    ...
    vl.test.assert_image("canvas_text", canvas,
                         hash_val='32d25897c7e06732f16df54bd79654e7')
    canvas.clear()
    ...
    canvas.text(pos=text_off, text=multiline_text, color=Colors.RED, font=font,
                ...
                _show_formatting=True)
    vl.test.assert_image("canvas_text", canvas,
                         hash_val='28e8c7e960f07711a4228ef98823b196')
    canvas.clear()
    ...
    canvas.text(pos=text_off, text="A bottom aligned text",
                ...
                _show_formatting=True)
    vl.test.assert_image("canvas_text", canvas,
                         hash_val='613419872ae15b7f711aca2f2244e7af')
    canvas.clear()
    canvas.text(pos=text_off, text=multiline_text, color=Colors.RED, font=font,
                center=True,
    ...
    vl.test.assert_image("canvas_text", canvas,
                         hash_val='29f469094776ef15d7176f9e846dd023')
