...
def test_checkerboard():
    ...
    """
    vl.test("Examples for basic shapes")
    ...
    cb.draw(canvas)
    vl.assert_image("checkerboard", canvas, "5559fd4635350f823434b37da31b6f4e")
    ...
    cb.draw(canvas)
    vl.assert_image("checkerboard", canvas, "212dc3bd9697b20e2117a86193495bea")
    vl.sub_test("A checkerboard with a specified "
           "column and row count")
    canvas.clear(Colors.BLACK)
    cb = Checkerboard(col_row_count=(16, 10), tile_size=16)
    cb.draw(canvas)
    vl.assert_image("checkerboard", canvas, "51b6fd23a7af332fd72bf2ad33aeb02e")
    vl.sub_test("A checkerboard with a specified "
    ...
    vl.assert_image("checkerboard", cb, "240be440718718180babb8af5ecfd955")
    vl.sub_test("A checkerboard with a specified "
